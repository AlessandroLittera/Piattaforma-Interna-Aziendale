...
namespace Provider.Sql.Migrations
{
    ...
    [Migration("20190515144823_foreign")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Provider.Sql.SqlAccount", b =>
                {
                    ...
                    b.Property<int?>("SqlAccountTypeId");

                    b.Property<int?>("SqlUserId");

                    b.HasKey("Id");

                    b.HasIndex("SqlAccountTypeId");
            ...
            modelBuilder.Entity("Provider.Sql.SqlAccountTypes.SqlAccountType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Provider.Sql.SqlAccountTypes.SqlDPO", b =>
                {
                    b.HasBaseType("Provider.Sql.SqlAccountTypes.SqlAccountType");
            ...
            modelBuilder.Entity("Provider.Sql.SqlAccount", b =>
                {
                    b.HasOne("Provider.Sql.SqlAccountTypes.SqlAccountType", "SqlAccountType")
                        .WithMany("SqlAccounts")
                        .HasForeignKey("SqlAccountTypeId");
